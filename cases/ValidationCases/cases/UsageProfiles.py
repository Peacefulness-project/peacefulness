# This script checks that the usage profiles work well
...
# hot water tanks
subclasses_dictionary["Device"]["HotWaterTank"]("hot_water_tank_early", elec_contract, early_hot_water_tank_owner, local_aggregator, "dummy_user_early", "dummy_usage", "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")
subclasses_dictionary["Device"]["HotWaterTank"]("hot_water_tank_month_dependency", elec_contract, month_dependency_hot_water_tank_owner, local_aggregator, "dummy_user_month_dependency", "dummy_usage", "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")
subclasses_dictionary["Device"]["HotWaterTank"]("hot_water_tank_short_period", elec_contract, short_period_hot_water_tank_owner, local_aggregator, "dummy_user_short_period", "dummy_usage", "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")
subclasses_dictionary["Device"]["HotWaterTank"]("hot_water_tank_2_usages", elec_contract, two_usages_hot_water_tank_owner, local_aggregator, "dummy_user_2_usages", "dummy_usage", "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")

# heatings
subclasses_dictionary["Device"]["Heating"]("heating_early", elec_contract, early_heating_owner, local_aggregator, "dummy_user_early", "dummy_elec", {"location": "Pau"}, "cases/ValidationCases/AdditionalData/DevicesProfiles/Heating.json")
subclasses_dictionary["Device"]["Heating"]("heating_hot", elec_contract, hot_heating_owner, local_aggregator, "dummy_user_hot", "dummy_elec", {"location": "Pau"}, "cases/ValidationCases/AdditionalData/DevicesProfiles/Heating.json")
subclasses_dictionary["Device"]["Heating"]("heating_short_usage", elec_contract, short_usage_heating_owner, local_aggregator, "dummy_user_short_usage", "dummy_elec", {"location": "Pau"}, "cases/ValidationCases/AdditionalData/DevicesProfiles/Heating.json")


# ##############################################################################################
# Creation of the validation daemon
description = "This script checks that the usage profiles work well"
