...
subclasses_dictionary["Device"]["HeatPump"]("converter", [BAU_contract_elec, BAU_contract_heat], converter_owner, aggregator_elec, aggregator_heat, {"device": "dummy_heat_pump"}, "cases/ValidationCases/AdditionalData/DevicesProfiles/HeatPump.json")
