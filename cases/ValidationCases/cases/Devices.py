...
wind_daemon = subclasses_dictionary["Daemon"]["WindDaemon"]({"location": "Pau"}, "cases/ValidationCases/AdditionalData/Meteo/WindProfiles.json")
...
subclasses_dictionary["Device"]["PV"]("PV", BAU_contract_elec, PV_owner, aggregator_elec, {"device": "dummy_usage"}, {"location": "Pau", "panels": 1}, "cases/ValidationCases/AdditionalData/DevicesProfiles/PV.json")
