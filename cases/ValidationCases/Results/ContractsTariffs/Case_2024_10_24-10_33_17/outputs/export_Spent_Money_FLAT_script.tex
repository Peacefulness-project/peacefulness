...
\pgfplotstableread[col sep=semicolon]{C:\Users\y23hallo\PycharmProjects\peacefulness\cases\ValidationCases\Results\ContractsTariffs\Case_2024_10_24-10_33_17\outputs\export_Spent_Money_FLAT.csv}{\data}

\begin{tikzpicture}
\begin{axis}[
	xmin = 2000-01-01 01:00:00, xmax = 2000-01-02 00:00:00, 
	ymin = 0, ymax = 2.3000000000000003, 
	xlabel = {$t \, [\si{\hour}]$},
	...
	\addplot+[mark=none, line width=1.25] table[ x = physical_time, y = flat_owner.money_spent_simulation]{\data};
	\legend{ ref., num.}
\end{axis}
\end{tikzpicture}
