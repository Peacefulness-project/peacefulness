...
\pgfplotstableread[col sep=semicolon]{C:\Users\y23hallo\PycharmProjects\peacefulness\cases\ValidationCases\Results\ContractsTariffs\Case_2024_09_23-18_15_25\outputs\export_Spent_Money_RTP.csv}{\data}
...
\begin{axis}[
	...
	\addplot+[mark=none, line width=1.25] table[ x = physical_time, y = RTP_owner.money_spent_simulation]{\data};
	\legend{ ref., num}
\end{axis}
\end{tikzpicture}
