...
name_world = "distribution_strategy"
...
# emergency strategy
device_early_emergency = subclasses_dictionary["Device"]["HotWaterTank"]("device_early_emergency", elec_contract, early_emergency_owner, aggregator_elec_emergency, {"user": "dummy_user_early", "device": "dummy_usage"}, {"cold_water_temperature_daemon": water_temperature_daemon.name}, "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")
device_expensive_emergency = subclasses_dictionary["Device"]["HotWaterTank"]("device_expensive_emergency", elec_expensive_contract, expensive_emergency_owner, aggregator_elec_emergency, {"user": "dummy_user", "device": "dummy_usage"}, {"cold_water_temperature_daemon": water_temperature_daemon.name}, "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")
device_consuming_emergency = subclasses_dictionary["Device"]["HotWaterTank"]("device_consuming_emergency", elec_contract, consuming_emergency_owner, aggregator_elec_emergency, {"user": "dummy_user", "device": "dummy_usage_consuming"}, {"cold_water_temperature_daemon": water_temperature_daemon.name}, "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")

production_emergency = subclasses_dictionary["Device"]["Background"]("production_emergency", producer_elec_contract, aggregators_manager, aggregator_elec_emergency, {"user": "dummy_user", "device": "dummy_producer_distribution_test"}, {"cold_water_temperature_daemon": water_temperature_daemon.name}, filename="cases/ValidationCases/AdditionalData/DevicesProfiles/Background.json")

# price strategy
device_early_price = subclasses_dictionary["Device"]["HotWaterTank"]("device_early_price", elec_contract, early_price_owner, aggregator_elec_price, {"user": "dummy_user_early", "device": "dummy_usage"}, {"cold_water_temperature_daemon": water_temperature_daemon.name}, "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")
device_expensive_price = subclasses_dictionary["Device"]["HotWaterTank"]("device_expensive_price", elec_expensive_contract, expensive_price_owner, aggregator_elec_price, {"user": "dummy_user", "device": "dummy_usage"}, {"cold_water_temperature_daemon": water_temperature_daemon.name}, "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")
...
# quantity strategy
device_early_quantity = subclasses_dictionary["Device"]["HotWaterTank"]("device_early_quantity", elec_contract, early_quantity_owner, aggregator_elec_quantity, {"user": "dummy_user_early", "device": "dummy_usage"}, {"cold_water_temperature_daemon": water_temperature_daemon.name}, "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")
...
# partial strategy
device_early_partial = subclasses_dictionary["Device"]["HotWaterTank"]("device_early_partial", elec_contract, early_partial_owner, aggregator_elec_partial, {"user": "dummy_user_early", "device": "dummy_usage"}, {"cold_water_temperature_daemon": water_temperature_daemon.name}, "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")
device_expensive_partial = subclasses_dictionary["Device"]["HotWaterTank"]("device_expensive_partial", elec_expensive_contract, expensive_partial_owner, aggregator_elec_partial, {"user": "dummy_user", "device": "dummy_usage"}, {"cold_water_temperature_daemon": water_temperature_daemon.name}, "cases/ValidationCases/AdditionalData/DevicesProfiles/HotWaterTank.json")
...
name = "LVE_quantity_energy_bought"
export_plot_quantity = {
    "name": name,
    "filename": "export_"+name,
    "options": GraphOptions(f"{name}_graph_options", ["csv", "LaTeX"], "multiple_series"),
    "X": {"catalog_name_entry": "iteration", "label": r"$t \, [\si{\hour}]$"},
    "Y": {"label": r"$\mathcal{C}_{ref.} \, [$\euro{}$]$",
          "graphs": [ {"catalog_name_entry": "early_quantity_owner.LVE.energy_bought_reference", "style": "points",  "legend": r"early"},
                      {"catalog_name_entry": "expensive_quantity_owner.LVE.energy_bought_reference", "style": "points", "legend": r"expens."},
                      {"catalog_name_entry": "consuming_quantity_owner.LVE.energy_bought_reference", "style": "points", "legend": r"consum."}
                    ]
          },
    "Y2": {"label": r"$\mathcal{C}_{num.} \, [$\euro{}$]$",
          "graphs": [ {"catalog_name_entry": "early_quantity_owner.LVE.energy_bought_simulation", "style": "lines",  "legend": r""},
...
name = "LVE_partial_energy_bought"
export_plot_partial = {
    "name": name,
    "filename": "export_"+name,
    "options": GraphOptions(f"{name}_graph_options", ["csv", "LaTeX"], "multiple_series"),
    "X": {"catalog_name_entry": "iteration", "label": r"$t \, [\si{\hour}]$"},
    "Y": {"label": r"$\mathcal{C}_{ref.} \, [$\euro{}$]$",
          "graphs": [ {"catalog_name_entry": "early_partial_owner.LVE.energy_bought_reference", "style": "points",  "legend": r"early"},
                      {"catalog_name_entry": "expensive_partial_owner.LVE.energy_bought_reference", "style": "points", "legend": r"expens."},
                      {"catalog_name_entry": "consuming_partial_owner.LVE.energy_bought_reference", "style": "points", "legend": r"consum."}
                    ]
          },
    "Y2": {"label": r"$\mathcal{C}_{num.} \, [$\euro{}$]$",
          "graphs": [ {"catalog_name_entry": "early_partial_owner.LVE.energy_bought_simulation", "style": "lines",  "legend": r""},
...
parameters = {"description": description, "filename": filename, "reference_values": reference_values, "tolerance": 1E-6, "export_plots": [export_plot_emergency, export_plot_price, export_plot_quantity, export_plot_partial]}
