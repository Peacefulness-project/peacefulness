...
pathExport = "cases/agent_templates/Results/WhenProfitable_revenues_high_DSM"
...
supervisor_elec = User.Strategies.WhenProfitableRevenues.WhenProfitableRevenues(name_supervisor, description)
...
supervisor_heat = User.Strategies.SubclusterHeatRevenues.SubclusterHeatRevenues(name_supervisor, description)
...
# BAU contracts
world.agent_generation(165, "lib/AgentTemplates/agent_templates/AgentSFT_1_BAU.json", [cluster_elec, cluster_heat])
world.agent_generation(330, "lib/AgentTemplates/agent_templates/AgentSFT_2_BAU.json", [cluster_elec, cluster_heat])
world.agent_generation(165, "lib/AgentTemplates/agent_templates/AgentSFT_5_BAU.json", [cluster_elec, cluster_heat])

# DLC contracts
world.agent_generation(200, "lib/AgentTemplates/agent_templates/AgentSFT_1_DLC.json", [cluster_elec, cluster_heat])
world.agent_generation(400, "lib/AgentTemplates/agent_templates/AgentSFT_2_DLC.json", [cluster_elec, cluster_heat])
world.agent_generation(200, "lib/AgentTemplates/agent_templates/AgentSFT_5_DLC.json", [cluster_elec, cluster_heat])

# Curtailment contracts
world.agent_generation(135, "lib/AgentTemplates/agent_templates/AgentSFT_1_curtailment.json", [cluster_elec, cluster_heat])
world.agent_generation(270, "lib/AgentTemplates/agent_templates/AgentSFT_2_curtailment.json", [cluster_elec, cluster_heat])
world.agent_generation(135, "lib/AgentTemplates/agent_templates/AgentSFT_5_curtailment.json", [cluster_elec, cluster_heat])
