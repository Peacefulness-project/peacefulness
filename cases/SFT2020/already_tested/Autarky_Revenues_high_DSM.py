...
pathExport = "cases/agent_templates/Results/Autarky_revenues_high_DSM"
...
supervisor_elec = User.Strategies.AutarkyRevenues.AutarkyRevenues(name_supervisor, description)
