...
pathExport = "cases/agent_templates/Results/WhenProfitable_partial_high_DSM"
...
supervisor_heat = User.Strategies.SubclusterHeatPartial.SubclusterHeatPartial(name_supervisor, description)
