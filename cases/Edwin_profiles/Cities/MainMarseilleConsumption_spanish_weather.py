...
outdoor_temperature_daemon = User.Daemons.OutdoorTemperatureDaemon.OutdoorTemperatureDaemon("Azzie", 1, {"file": "lib/MeteorologicalData/TemperaturesProfiles/ZaragozaTemperatures.json"})
