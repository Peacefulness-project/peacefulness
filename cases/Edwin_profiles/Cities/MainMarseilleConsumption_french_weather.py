...
name_world = "Marseille_city"
world = World(name_world)  # creation


# ##############################################################################################
# Definition of the path to the files
pathExport = "cases/Edwin_profiles/Results/Marseille"  # directory where results are written
...
supervisor_cold = User.Strategies.SubclusterHeatEmergency.SubclusterHeatEmergency(name_supervisor, description)
...
# BAU contracts
world.agent_generation(15, "lib/AgentTemplates/agent_templates/Apartment_1_France.json", [cluster_elec, cluster_heat, cluster_cold])
world.agent_generation(20, "lib/AgentTemplates/agent_templates/Apartment_2_France.json", [cluster_elec, cluster_heat, cluster_cold])
world.agent_generation(15, "lib/AgentTemplates/agent_templates/Apartment_5_France.json", [cluster_elec, cluster_heat, cluster_cold])
...
outdoor_temperature_daemon = User.Daemons.OutdoorTemperatureDaemon.OutdoorTemperatureDaemon("Azzie", 1, {"file": "lib/MeteorologicalData/TemperaturesProfiles/MarseilleTemperatures.json"})
