...
# name_world = "Zaragoza_city"
# world = World(name_world)  # creation
#
#
# # ##############################################################################################
# # Definition of the path to the files
# pathExport = "cases/Edwin_profiles/Results/Zaragoza"  # directory where results are written
...
# supervisor_cold = User.Supervisors.SubclusterHeatEmergency.SubclusterHeatEmergency(name_supervisor, description)
# world.register_supervisor(supervisor_cold)
#
...
# cold = Nature(nature_name, nature_description)  # creation of a nature
...
# # BAU_elec = User.Contract.TOUEgoistContract.TOUEgoistContract("BAU_elec", elec, {"selling_price": 0, "buying_price": 0})
# # world.register_contract(BAU_elec)
# #
# # BAU_heat = User.Contract.FlatEgoistContract.FlatEgoistContract("BAU_heat", heat, {"selling_price": 0, "buying_price": 0})
# # world.register_contract(BAU_heat)
# #
# # # cooperative_contract_elec = User.Contract.FlatCooperativeContract.FlatCooperativeContract("cooperative_contract_elec", elec, {"selling_price": 0.1, "buying_price": 0.12})
# # # world.register_contract(cooperative_contract_elec)
# #
# # cooperative_contract_heat = User.Contract.FlatCooperativeContract.FlatCooperativeContract("cooperative_contract_heat", heat, {"selling_price": 0, "buying_price": 0})
...
#
# # # BAU contracts
# world.agent_generation(15, "lib/AgentTemplates/agent_templates/Apartment_1_Spain.json", [cluster_elec, cluster_heat, cluster_cold])
# world.agent_generation(20, "lib/AgentTemplates/agent_templates/Apartment_2_Spain.json", [cluster_elec, cluster_heat, cluster_cold])
# world.agent_generation(15, "lib/AgentTemplates/agent_templates/Apartment_5_Spain.json", [cluster_elec, cluster_heat, cluster_cold])
#
...
# price_manager_elec = User.Daemon.PriceManagerTOUDaemon.PriceManagerTOUDaemon("Picsou", 1, {"nature": elec.name, "buying_prices": [0.0, 0.0], "selling_prices": [0, 0], "hours": [[6, 12], [14, 23]]})  # sets prices for TOU rate
# price_elec_grid = User.Daemon.GridPricesDaemon.GridPricesDaemon("LVE_tariffs", 1, {"nature": elec.name, "grid_buying_price": 0., "grid_selling_price": 0.})  # sets prices for the system operator
# price_heat_grid = User.Daemon.GridPricesDaemon.GridPricesDaemon("Heat_tariffs", 1, {"nature": heat.name, "grid_buying_price": 0.0, "grid_selling_price": 0.00})  # sets prices for the system operator
# price_cool_grid = User.Daemon.GridPricesDaemon.GridPricesDaemon("Cool_tariffs", 1, {"nature": cold.name, "grid_buying_price": 0.0, "grid_selling_price": 0.00})  # sets prices for the system operator
...
# world.register_daemon(price_cool_grid)  # registration
#
# # Outdoor temperature
# # this daemon is responsible for the value of outdoor temperature in the catalog
# outdoor_temperature_daemon = User.Daemon.OutdoorTemperatureDaemon.OutdoorTemperatureDaemon("Azzie", 1, {"file": "lib/MeteorologicalData/TemperaturesProfiles/ZaragozaTemperatures.json"})
# world.register_daemon(outdoor_temperature_daemon)  # registration
#
# # Indoor temperature
# # this daemon is responsible for the value of indoor temperatures in the catalog
# indoor_temperature_daemon = User.Daemon.IndoorTemperatureDaemon.IndoorTemperatureDaemon("Asie", 1)
# world.register_daemon(indoor_temperature_daemon)  # registration
#
# # Water temperature
# # this daemon is responsible for the value of the water temperature in the catalog
# water_temperature_daemon = User.Daemon.ColdWaterDaemon.ColdWaterDaemon("Mephisto", 1)
# world.register_daemon(water_temperature_daemon)  # registration
#
# # # Irradiation
# # # this daemon is responsible for updating the value of raw solar irradiation
# # irradiation_daemon = User.Daemon.IrradiationDaemon.IrradiationDaemon("Pau")
...
# # contract_balances = User.Datalogger.Balances.ContractBalanceDatalogger()
# # cluster_balances = User.Datalogger.Balances.ClusterBalanceDatalogger()
# nature_balances = User.Datalogger.Balances.NatureBalanceDatalogger()
...
#
# # ECOS_agent_datalogger = User.Datalogger.ECOSDatalogger.ECOSAgentDatalogger("month")
# # ECOS_cluster_datalogger = User.Datalogger.ECOSDatalogger.ECOSDatalogger()
# # global_values_datalogger = User.Datalogger.ECOSDatalogger.GlobalValuesDatalogger()
...
# # consumption_datalogger = Datalogger("producer_datalogger", "ProducerBalances.txt")
# # world.register_datalogger(consumption_datalogger)  # registration
#
#
# # CPU time measurement
