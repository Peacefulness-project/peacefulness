...
pathExport = "cases/ECOS_collab_2020/Results/Profitable_high_DSM_mean"
...
cluster_heat = Aggregator(cluster_name, heat, supervisor_heat, cluster_elec, 3.6, 3000)  # creation of a cluster
