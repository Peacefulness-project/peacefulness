...
pathExport = "cases/ECOS_collab_2020/Results/Profitable_high_DSM_peak"
...
supervisor_elec = User.Strategies.WhenProfitableEmergency.WhenProfitableEmergency(name_supervisor, description)
...
cluster_heat = Aggregator(cluster_name, heat, supervisor_heat, cluster_elec, 3.6, 4400)  # creation of a cluster
...
PV_field = User.Devices.NonControllableDevice.PV.PV("PV_field", BAU_elec, PV_producer, cluster_elec, "ECOS", "ECOS_field", {"surface": 54000})  # creation of a photovoltaic panel field
world.register_device(PV_field)  # registration of a production device

solar_thermal_collector_field = User.Devices.NonControllableDevice.SolarThermalCollector.SolarThermalCollector("solar_thermal_collector_field", BAU_heat, solar_thermal_collector_producer, cluster_heat, "ECOS", "ECOS_field", {"surface": 23550})  # creation of a solar thermal collector
...
# BAU contracts
world.agent_generation(165, "lib/AgentTemplates/ECOS2020/AgentECOS_1_BAU.json", [cluster_elec, cluster_heat])
world.agent_generation(330, "lib/AgentTemplates/ECOS2020/AgentECOS_2_BAU.json", [cluster_elec, cluster_heat])
world.agent_generation(165, "lib/AgentTemplates/ECOS2020/AgentECOS_5_BAU.json", [cluster_elec, cluster_heat])

# DLC contracts
world.agent_generation(200, "lib/AgentTemplates/ECOS2020/AgentECOS_1_DLC.json", [cluster_elec, cluster_heat])
world.agent_generation(400, "lib/AgentTemplates/ECOS2020/AgentECOS_2_DLC.json", [cluster_elec, cluster_heat])
world.agent_generation(200, "lib/AgentTemplates/ECOS2020/AgentECOS_5_DLC.json", [cluster_elec, cluster_heat])

# Curtailment contracts
world.agent_generation(135, "lib/AgentTemplates/ECOS2020/AgentECOS_1_curtailment.json", [cluster_elec, cluster_heat])
world.agent_generation(270, "lib/AgentTemplates/ECOS2020/AgentECOS_2_curtailment.json", [cluster_elec, cluster_heat])
world.agent_generation(135, "lib/AgentTemplates/ECOS2020/AgentECOS_5_curtailment.json", [cluster_elec, cluster_heat])
...
price_manager_elec = User.Daemons.PriceManagerDaemonTOU.PriceManagerDaemonTOU("Picsou", 1, {"nature": elec.name, "buying_prices": [0.4375, 0.3125], "selling_prices": [0, 0], "hours": [[6, 12], [14, 23]]})  # sets prices for flat rate
...
price_heat_grid = User.Daemons.GridPricesDaemon.GridPricesDaemon("Heat_tariffs", 1, {"nature": heat.name, "grid_buying_price": 0.5125, "grid_selling_price": 0})  # sets prices for the system operator
