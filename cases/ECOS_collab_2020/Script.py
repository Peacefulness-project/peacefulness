...
def simulation(strategy, DSM_proportion, sizing):
    ...
    # BAU contracts
    world.agent_generation(BAU, "cases/ECOS_collab_2020/AgentTemplates/AgentECOS_1_BAU.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(BAU * 2, "cases/ECOS_collab_2020/AgentTemplates/AgentECOS_2_BAU.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(BAU, "cases/ECOS_collab_2020/AgentTemplates/AgentECOS_5_BAU.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})

    # DLC contracts
    world.agent_generation(DLC, "cases/ECOS_collab_2020/AgentTemplates/AgentECOS_1_DLC.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(DLC * 2, "cases/ECOS_collab_2020/AgentTemplates/AgentECOS_2_DLC.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(DLC, "cases/ECOS_collab_2020/AgentTemplates/AgentECOS_5_DLC.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})

    # Curtailment contracts
    world.agent_generation(curtailment, "cases/ECOS_collab_2020/AgentTemplates/AgentECOS_1_curtailment.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(curtailment * 2, "cases/ECOS_collab_2020/AgentTemplates/AgentECOS_2_curtailment.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(curtailment, "cases/ECOS_collab_2020/AgentTemplates/AgentECOS_5_curtailment.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
