...
def simulation(exchange_strategy, distribution_strategy, renewable_proportion, DSM_proportion):
    ...
    pathExport = "cases/Studies/ECOS_TestCases_2020/Results/" + exchange_strategy + "_" + distribution_strategy + "_" + DSM_proportion + "_" + renewable_proportion  # directory where results are written
    ...
    world.agent_generation(DLC * 2, "cases/Studies/ECOS_TestCases_2020/AgentTemplates/AgentECOS_2_DLC.json", [aggregator_elec], {"LVE": price_managing_elec})
    world.agent_generation(DLC, "cases/Studies/ECOS_TestCases_2020/AgentTemplates/AgentECOS_5_DLC.json", [aggregator_elec], {"LVE": price_managing_elec})
