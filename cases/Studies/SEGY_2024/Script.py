...
def simulation(DSM_proportion, strategy_exchange, strategy_distribution, grid):
    ...
    pathExport = "cases/Studies/SEGY_2024/Results/" + str(DSM_proportion) + "_" + strategy_exchange + "_" + strategy_distribution + "_" + grid  # directory where results are written
    ...
    if grid == "mixed":
        ...
        if strategy_exchange != "BAU": # in cases with DSM, the power of the HP is considered "infinite" and equal to 10 MW otherwise
            aggregator_heat = Aggregator(aggregator_name, LTH, supervisor_heat, DHN_manager, aggregator_elec, contract_DHN, 2.5, {"buying": 2000, "selling": 0})  # creation of a aggregator
        else:
            aggregator_heat = Aggregator(aggregator_name, LTH, supervisor_heat, DHN_manager, aggregator_elec, contract_DHN, 2.5, {"buying": 2000, "selling": 0})  # creation of a aggregator
    ...
    if grid == "mixed":
        subclasses_dictionary["Device"]["DummyProducer"]("heat_production", contract_flexible_production_heat, producer, aggregator_heat, {"device": "heat"}, {"max_power": 7100})  # creation of a heat production unit
    elif grid == "elec":
    ...
    if grid == "mixed":
        # BAU contracts
        world.agent_generation("1_mixed_BAU", BAU * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_mixed_1_BAU.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec_BAU, "LTH": price_managing_heat_BAU}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("2_mixed_BAU", BAU * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_mixed_2_BAU.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec_BAU, "LTH": price_managing_heat_BAU}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("5_mixed_BAU", BAU, "cases/Studies/SEGY_2024/AgentTemplates/Agent_mixed_5_BAU.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec_BAU, "LTH": price_managing_heat_BAU}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})

        # DLC contracts
        world.agent_generation("1_mixed_DLC", DLC * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_mixed_1_DLC.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec_DLC, "LTH": price_managing_heat_DLC}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("2_mixed_DLC", DLC * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_mixed_2_DLC.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec_DLC, "LTH": price_managing_heat_DLC}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("5_mixed_DLC", DLC, "cases/Studies/SEGY_2024/AgentTemplates/Agent_mixed_5_DLC.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec_BAU, "LTH": price_managing_heat_BAU}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})

        # Curtailment contracts
        world.agent_generation("1_mixed_curtailment", curtailment * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_mixed_1_curtailment.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec_DLC, "LTH": price_managing_heat_DLC}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("2_mixed_curtailment", curtailment * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_mixed_2_curtailment.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec_DLC, "LTH": price_managing_heat_DLC}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("5_mixed_curtailment", curtailment, "cases/Studies/SEGY_2024/AgentTemplates/Agent_mixed_5_curtailment.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec_BAU, "LTH": price_managing_heat_BAU}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})

    elif grid == "elec":
        # BAU contracts
        world.agent_generation("1_elec_BAU", BAU * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_elec_1_BAU.json", aggregator_elec, {"LVE": price_managing_elec_BAU}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("2_elec_BAU", BAU * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_elec_2_BAU.json", aggregator_elec, {"LVE": price_managing_elec_BAU}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("5_elec_BAU", BAU, "cases/Studies/SEGY_2024/AgentTemplates/Agent_elec_5_BAU.json", aggregator_elec, {"LVE": price_managing_elec_BAU}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})

        # DLC contracts
        world.agent_generation("1_elec_DLC", DLC * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_elec_1_DLC.json", aggregator_elec, {"LVE": price_managing_elec_DLC}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("2_elec_DLC", DLC * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_elec_2_DLC.json", aggregator_elec, {"LVE": price_managing_elec_DLC}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("5_elec_DLC", DLC, "cases/Studies/SEGY_2024/AgentTemplates/Agent_elec_5_DLC.json", aggregator_elec, {"LVE": price_managing_elec_DLC}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})

        # Curtailment contracts
        world.agent_generation("1_elec_curtailment", curtailment * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_elec_1_curtailment.json", aggregator_elec, {"LVE": price_managing_elec_DLC}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("2_elec_curtailment", curtailment * 2, "cases/Studies/SEGY_2024/AgentTemplates/Agent_elec_2_curtailment.json", aggregator_elec, {"LVE": price_managing_elec_DLC}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
        world.agent_generation("5_elec_curtailment", curtailment, "cases/Studies/SEGY_2024/AgentTemplates/Agent_elec_5_curtailment.json", aggregator_elec, {"LVE": price_managing_elec_DLC}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
