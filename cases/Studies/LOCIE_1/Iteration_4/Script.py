...
def simulation(strategy, DSM_proportion, sizing, panels_and_LCOE):
    ...
    pathExport = "cases/Studies/LOCIE_1/Iteration_4/Results/" + strategy + "_" + DSM_proportion + "_" + sizing  # directory where results are written
    ...
    subclasses_dictionary["Device"]["PV"]("PV_field", contract_elec, PV_producer, aggregator_elec, {"device": "standard_field"}, {"panels": panels_elec, "irradiation_daemon": irradiation_daemon.name, "outdoor_temperature_daemon": outdoor_temperature_daemon.name})  # creation of a photovoltaic panel field
