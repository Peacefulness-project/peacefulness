...
def simulation(strategy, DSM_proportion, sizing, panels_and_LCOE):
    ...
    pathExport = "cases/Studies/LOCIE_1/FigureRuns/Results/Week/" + strategy + "_" + DSM_proportion + "_" + sizing   # directory where results are written
    ...
    world.set_time(start_date,  # time management: start date
                   ...
                   24 + 3)  # number of time steps simulated
    ...
    datalogger_individual_consumption = Datalogger("individual_consumption", "IndividualConsumption", graph_options=graph_options, graph_labels={"xlabel": "time (\\textit{h})", "ylabel": "consumption (\\textit{kWh})"})

    datalogger_individual_consumption.add("simulation_time", graph_status="X")
    datalogger_individual_consumption.add("1_people_BAU_0.LVE.energy_bought", graph_legend="electricity consumption")
    datalogger_individual_consumption.add("1_people_BAU_0.LTH.energy_bought", graph_legend="heat consumption")
