...
def simulation(month):
    ...
    pathExport = "cases/Studies/LOCIE_1/FigureRuns/Results/MonthlyVariationOfConsumption/Month" + str(month)   # directory where results are written
    ...
    world.agent_generation(BAU, "cases/Studies/LOCIE_1/AgentTemplates/AgentECOS_2_BAU.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat}, {"outdoor_temperature_daemon": outdoor_temperature_daemon, "cold_water_temperature_daemon": cold_water_temperature_daemon})
    ...
    # heating consumption
    datalogger_heating_consumption = Datalogger("heating_consumption", "HeatingConsumption", 1)

    datalogger_heating_consumption.add("1_people_BAU_0_Heating_0.LTH.energy_accorded", function=get_quantity)
    datalogger_heating_consumption.add("2_people_BAU_0_Heating_0.LTH.energy_accorded", function=get_quantity)
    datalogger_heating_consumption.add("5_people_BAU_0_Heating_0.LTH.energy_accorded", function=get_quantity)

    # hot water tank consumption
    datalogger_hot_water_tank_consumption = Datalogger("hot_water_tank_consumption", "hot_water_tankConsumption", 1)

    datalogger_hot_water_tank_consumption.add("1_people_BAU_0_HotWaterTank_0.LTH.energy_accorded", function=get_quantity)
    datalogger_hot_water_tank_consumption.add("2_people_BAU_0_HotWaterTank_0.LTH.energy_accorded", function=get_quantity)
    datalogger_hot_water_tank_consumption.add("5_people_BAU_0_HotWaterTank_0.LTH.energy_accorded", function=get_quantity)
