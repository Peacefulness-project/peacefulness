...
def simulation(habits, weather_city, set_point):
    ...
    pathExport = "cases/Studies/Edwin_profiles/Results/" + habits + "_habits_" + weather_city + "_weather_" + set_point + "_set_point"  # directory where results are written
    ...
    # Devices
    # BAU contracts
    world.agent_generation(15, "cases/Studies/Edwin_profiles/AgentTemplates/Apartment_1_" + weather_city + "_weather_" + habits + "_habits_" + set_point + "_set_point.json", [aggregator_elec, aggregator_heat, aggregator_cold], {"LVE": price_managing_elec, "LTH": price_managing_heat, "HTC": price_managing_cold})
    world.agent_generation(20, "cases/Studies/Edwin_profiles/AgentTemplates/Apartment_2_" + weather_city + "_weather_" + habits + "_habits_" + set_point + "_set_point.json", [aggregator_elec, aggregator_heat, aggregator_cold], {"LVE": price_managing_elec, "LTH": price_managing_heat, "HTC": price_managing_cold})
    world.agent_generation(15, "cases/Studies/Edwin_profiles/AgentTemplates/Apartment_5_" + weather_city + "_weather_" + habits + "_habits_" + set_point + "_set_point.json", [aggregator_elec, aggregator_heat, aggregator_cold], {"LVE": price_managing_elec, "LTH": price_managing_heat, "HTC": price_managing_cold})
