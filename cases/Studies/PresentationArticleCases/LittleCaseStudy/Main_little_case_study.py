# execute all files in the sub-directory "ECOS_TestCases_2020"
from os import listdir, chdir


chdir("../../../../")  # set the relative path to the project root

root_path = "cases/Studies/PresentationArticleCases/LittleCaseStudy/cases/"  # the path to the cases
