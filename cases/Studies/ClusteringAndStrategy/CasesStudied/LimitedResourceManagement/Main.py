...
results_path = "cases/Studies/ClusteringAndStrategy/Results/LimitedResource/"
# export management
...
for i in range(2, 10):
    ...
    start_time = time.process_time()
    best_strategies = training(training_simulation_length, cluster_centers, performance_norm, exported_metrics, assessed_priorities, create_simulation, "LimitedResource", clustering_metrics)
