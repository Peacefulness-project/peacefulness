...
# if "LimitedResource" not in os.listdir("./cases/Studies/ClusteringAndStrategy/Results/LimitedResource/BatchSize"):
...
for i in range(1, 11):
    ...
    start_time = time.process_time()
    tested_performance, clusters_situation = assess_performance(best_strategies, cluster_centers, clustering_metrics, comparison_simulation_length, performance_norm, ref_priorities_consumption, ref_priorities_production, exported_metrics, create_simulation, "BatchSize")
