...
def create_simulation(hours_simulated: int, path_name: str, metrics: list = [], random_seed: int = 0, standard_deviation: float = 0.25):
    ...
    pathExport = "cases/Studies/ClusteringAndStrategy/Results/LimitedResource/" + path_name
    ...
    # storage
    subclasses_dictionary["Device"]["ElectricalBattery"]("storage", cooperative_contract_elec, grid_manager, aggregator_elec, {"device": "ECOS2025"}, {"capacity": 1000, "initial_SOC": 0.5},
