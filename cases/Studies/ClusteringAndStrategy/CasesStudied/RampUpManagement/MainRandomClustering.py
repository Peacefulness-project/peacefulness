...
for i in range(10):
    ...
    cluster_centers, center_sequences, cluster_size = clustering(cluster_number, clustering_metrics, recorded_situations, clustering_sequences_number, random_seed=100*i)
