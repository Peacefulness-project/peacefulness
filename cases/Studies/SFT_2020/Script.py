...
def simulation(exchange_strategy, distribution_strategy, DSM_proportion):
    ...
    pathExport = "cases/Studies/SFT_2020/Results/" + exchange_strategy + "_" + distribution_strategy + "_" + DSM_proportion  # directory where results are written
    ...
    # BAU contracts
    world.agent_generation(BAU, "cases/Studies/SFT_2020/AgentTemplates/AgentSFT_1_BAU.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(BAU * 2, "cases/Studies/SFT_2020/AgentTemplates/AgentSFT_2_BAU.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(BAU, "cases/Studies/SFT_2020/AgentTemplates/AgentSFT_5_BAU.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})

    # DLC contracts
    world.agent_generation(DLC, "cases/Studies/SFT_2020/AgentTemplates/AgentSFT_1_DLC.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(DLC * 2, "cases/Studies/SFT_2020/AgentTemplates/AgentSFT_2_DLC.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(DLC, "cases/Studies/SFT_2020/AgentTemplates/AgentSFT_5_DLC.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})

    # Curtailment contracts
    world.agent_generation(curtailment, "cases/Studies/SFT_2020/AgentTemplates/AgentSFT_1_curtailment.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(curtailment * 2, "cases/Studies/SFT_2020/AgentTemplates/AgentSFT_2_curtailment.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
    world.agent_generation(curtailment, "cases/Studies/SFT_2020/AgentTemplates/AgentSFT_5_curtailment.json", [aggregator_elec, aggregator_heat], {"LVE": price_managing_elec, "LTH": price_managing_heat})
