...
class Supervisor:
    ...
    def _price_sort(self, cluster):  # a function calculating the emergency associated with devices and returning 2 sorted lists: one for the demands and one for the offers
        ...
        sorted_demands = sorted(sorted_demands, key=get_price, reverse=True)  # decreasing prices of buying
        sorted_offers = sorted(sorted_offers, key=get_price, reverse=False)  # increasing prices of selling
