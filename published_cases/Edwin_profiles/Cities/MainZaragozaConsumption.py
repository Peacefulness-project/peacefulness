...
# pathExport = "published_cases/Edwin_profiles/Results/Zaragoza"  # directory where results are written
...
#
# # # BAU contracts
# world.agent_generation(15, "usr/AgentTemplates/CollabEdwin/Apartment_1_Spain.json", [cluster_elec, cluster_heat, cluster_cold])
# world.agent_generation(20, "usr/AgentTemplates/CollabEdwin/Apartment_2_Spain.json", [cluster_elec, cluster_heat, cluster_cold])
# world.agent_generation(15, "usr/AgentTemplates/CollabEdwin/Apartment_5_Spain.json", [cluster_elec, cluster_heat, cluster_cold])
#
...
# outdoor_temperature_daemon = User.Daemons.OutdoorTemperatureDaemon.OutdoorTemperatureDaemon("Azzie", 1, {"file": "usr/MeteorologicalData/TemperaturesProfiles/ZaragozaTemperatures.json"})
