...
pathExport = "published_cases/Edwin_profiles/Results/Marseille"  # directory where results are written
...
outdoor_temperature_daemon = User.Daemons.OutdoorTemperatureDaemon.OutdoorTemperatureDaemon("Azzie", 1, {"file": "usr/MeteorologicalData/TemperaturesProfiles/MarseilleTemperatures.json"})
