...
pathExport = "published_cases/ECOS_TestCases_2020/Results/Autarky_emergency_high_DSM_low_renewable"
...
PV_field = User.Devices.NonControllableDevice.PV.PV("PV_field", BAU_elec, PV_producer, cluster_elec, "ECOS", "ECOS_field", {"surface": 6700})  # creation of a photovoltaic panel field
