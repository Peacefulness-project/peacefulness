...
pathExport = "published_cases/ECOS_TestCases_2020/Results/Profitable_partial_high_DSM_low_renewable"
...
supervisor_elec = User.Strategies.WhenProfitablePartial.WhenProfitablePartial(name_supervisor, description)
