...
class AverageAgentBalancesDatalogger(Datalogger):  # a sub-class of dataloggers designed to export the balances

    def __init__(self, period=1, graph_options="default"):
        if period == "global":
            super().__init__("average_agent_balances_global", "AgentsBalances_global", period)
        else:
