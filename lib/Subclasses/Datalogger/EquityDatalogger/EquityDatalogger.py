        ...
        def create_get_max_diff_quantity_function(device_name, nature_name):
            ...
            def get_accorded(name):
                ...
                if abs(min_wanted_quantity - max_wanted_quantity) < 1e-6 :
                    ...
                    return_value = abs((given_quantity - min_wanted_quantity) / (max_wanted_quantity - min_wanted_quantity))  # todo equity for smaller consumers
                    # return_value = abs(given_quantity - min_wanted_quantity)  # todo equity for bigger consumers
