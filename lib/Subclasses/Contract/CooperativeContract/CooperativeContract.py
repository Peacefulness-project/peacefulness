...
class CooperativeContract(Contract):
    ...
    def contract_modification(self, message, name):  # as the tariffs are not the same for selling or buying energy, this function redirects to the relevant function
