...
class CylindroParabolicCSP(NonControllableDevice):

    def __init__(self, name, contracts, agent, aggregators, profiles, parameters, filename="lib\Subclasses\Device\CylindroParobolicCSP\CylindroParabolicCSP.json"):
    ...
    def update(self):  # method updating needs of the devices before the supervision
        ...
        azimut = self._catalog.get(f"{self._location}.azimut")
