...
class HeatPump(Converter):
    ...
    def __init__(self, name, contracts, agent, upstream_aggregator, downstream_aggregator, profiles, parameters=None, filename="lib/Subclasses/Device/HeatPump/ElectricalBattery.json"):
