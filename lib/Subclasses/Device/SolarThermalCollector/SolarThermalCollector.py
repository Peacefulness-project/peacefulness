...
class SolarThermalCollector(NonControllableDevice):
    ...
    def __init__(self, name, contracts, agent, aggregators, profiles, parameters, filename="lib/Subclasses/Device/SolarThermalCollector/SolarThermalCollector.json"):
        ...
        self._outoor_temperature_location = parameters["outdoor_temperature_daemon"].location  # the location of the device, in relation with the meteorological data
    ...
    def update(self):  # method updating needs of the devices before the supervision
        ...
        temperature = self._catalog.get(f"{self._outoor_temperature_location}.current_outdoor_temperature")
        ...
        reference_temperature = self._catalog.get(f"{self._outoor_temperature_location}.reference_temperature")
