...
class Cooling(AdjustableDevice):
    ...
    def __init__(self, name, contracts, agent, aggregators, user_profile_name, usage_profile_name, parameters, filename="lib/Subclasses/Device/Cooling/Cooling.json"):
    ...
    def update(self):  # method updating needs of the devices before the supervision
        ...
        for line in self._user_profile:
            ...
            if line[0] == self._moment:  # if a consumption has been scheduled and if it has not been fulfilled yet
                ...
                deltaTmin = line[2][2] - current_outdoor_temperature
                deltaTnom = line[2][1] - current_outdoor_temperature
                deltaTmax = line[2][0] - current_outdoor_temperature
