...
class MaxSellFullButFew(Strategy):

    def __init__(self, distribution_ranking_function: Callable):
        super().__init__(f"max_sell_strategy_{distribution_ranking_function.__name__}", "Always tries to buy the maximum energy possible outside. During distribution, serves totaaly a restricted number of devices, according to the distribution ranking function.")
