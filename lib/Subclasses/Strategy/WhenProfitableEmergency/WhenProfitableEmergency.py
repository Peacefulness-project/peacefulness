...
class WhenProfitableEmergency(Strategy):

    def __init__(self):
        super().__init__("when_profitable_emergency_strategy", "Distributes energy only when the aggregator makes a profit. During distribution, serves by decreasing emergency.")
