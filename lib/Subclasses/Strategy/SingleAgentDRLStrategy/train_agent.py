...
obj = {
       ...
       "aggregator_costs": 1.25,
       "social_cost": 1.2,
       "gas_cost": 1,
       "waste_cost": 0.8, "heatSink_cost": 0.8,
       "green_injection": 2
}
...
# MEG_caseStudy_env = PeacefulnessEnv(my_path, world_name, start_time, simulation_length, export_path, obs_size, action_info, obj,
#                               normalizing_parameters,
