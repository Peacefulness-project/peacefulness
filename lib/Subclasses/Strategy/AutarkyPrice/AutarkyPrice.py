...
class AutarkyPrice(Strategy):

    def __init__(self):
        super().__init__("autarky_price_strategy", "Never try to buy/sell energy from/to outside. During distribution, serves by decreasing emergency.")
