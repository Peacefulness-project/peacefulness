...
class ExchangesEmergency(Strategy):

    def __init__(self):
        super().__init__("exchanges_emergency_strategy", "Always tries to buy the maximum energy possible outside. During distribution, serves by decreasing emergency.")
