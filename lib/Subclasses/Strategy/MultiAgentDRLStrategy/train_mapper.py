...
normalization_dict = {"energy_minimum": -25000.0, "energy_maximum": 35000.0}
error_tolerance = 100.0  # kWh
...
agent_1_pif = FeasibilityPolicy(state_dim=20, latent_dim=8)
agent_1_trainer = FeasibilityPolicyTrainer(agent_1_pif, relevant_state_sample, connected_constraint_oracle,
                                           at_dim=8, latent_samples_per_state=4096, states_per_batch=16,
