...
class AutarkyQuantity(Strategy):

    def __init__(self):
        super().__init__("autarky_quantity_strategy", "Never try to buy/sell energy from/to outside. During distribution, serves by decreasing emergency.")
