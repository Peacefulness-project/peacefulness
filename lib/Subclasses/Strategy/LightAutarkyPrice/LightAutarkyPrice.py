...
class LightAutarkyPrice(Strategy):

    def __init__(self):
        super().__init__("light_autarky_price_strategy", "buy/sell energy from/to outside only when it cannot serve urgent demands. During distribution, serves by decreasing emergency.")
