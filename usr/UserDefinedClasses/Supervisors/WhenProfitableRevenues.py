...
class WhenProfitableRevenues(Supervisor):
    ...
    def distribute_remote_energy(self, cluster):  # after having exchanged with the exterior, the cluster
        ...
        # formulation of needs
        [sorted_demands, sorted_offers] = self._revenues_sort(cluster)  # sort the quantities according to their prices
...
user_classes_dictionary[f"{WhenProfitableRevenues.__name__}"] = WhenProfitableRevenues
