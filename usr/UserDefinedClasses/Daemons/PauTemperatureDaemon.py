...
class PauTemperatureDaemon(Daemon):
    ...
    def _user_register(self):
        ...
        for agent_name in self._agent_list:
            self._catalog.set(f"{agent_name}.previous_indoor_temperature", self._temperatures[current_month][current_hour])
            self._catalog.set(f"{agent_name}.current_indoor_temperature", self._temperatures[current_month][current_hour])
