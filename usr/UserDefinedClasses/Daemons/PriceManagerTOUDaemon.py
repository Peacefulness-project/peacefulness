...
from usr.UserDefinedClasses.Daemons.PriceManagerDaemon import PriceManagerDaemon
from tools.UserClassesDictionary import user_classes_dictionary


class PriceManagerTOUDaemon(PriceManagerDaemon):
    ...
    def _user_register(self):
        ...
        super()._user_register()  # apply the operations relative to price manager daemons
...
user_classes_dictionary[f"{PriceManagerTOUDaemon.__name__}"] = PriceManagerTOUDaemon
