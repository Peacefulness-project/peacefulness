...
def get_1_day_per_month(values, physical_time: datetime, time_offset=0):  # this methods is here to get the temperature when the format is 1 day/month
    physical_time = physical_time + timedelta(time_offset/24)  # this allows to get previous or next values of the data
...
def get_365_days(values, physical_time: datetime, time_offset=0):
    physical_time = physical_time + timedelta(time_offset/24)  # this allows to get previous or next values of the data
...
def get_non_periodic_values(values, physical_time: datetime, time_offset=0):
    physical_time = physical_time + timedelta(time_offset/24)  # this allows to get previous or next values of the data
    current_datetime = str(physical_time)
    return values[current_datetime]


def get_each_hour_per_month(values, physical_time: datetime, time_offset=0):  # this methods is here to get the irradiation when the format is 1 day/month
    physical_time = physical_time + timedelta(time_offset/24)  # this allows to get previous or next values of the data
...
def get_1_values_per_month(values, physical_time: datetime, time_offset=0):  # this methods is here to get the temperature when the format is 1 day/month
    physical_time = physical_time + timedelta(time_offset/24)  # this allows to get previous or next values of the data
    month = physical_time.month  # the current month
...
def get_1_day_per_year(values, physical_time: datetime, time_offset=0):
    physical_time = physical_time + timedelta(time_offset/24)  # this allows to get previous or next values of the data
